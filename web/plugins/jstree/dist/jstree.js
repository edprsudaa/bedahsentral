...
/*jshint -W083 */
	...
	$.jstree.defaults.core = {
		 ...
		 *
		 * It is possible to pass in a standard jQuery-ilike AJAX config and jstree will automatically determine if the response is JSON or HTML and use that to populate the tree.
		 ...
		 * If left as `false` all operations ilike create, rename, delete, move or copy are prevented.
		...
		/**
		 * Default keyboard shortcuts (an object where each key is the button name or combo - ilike 'enter', 'ctrl-space', 'p', etc and the value is the function to execute in the instance's scope)
 ...
 */
	...
	$.jstree.defaults.contextmenu = {
		 ...
		 * * `shortcut_label` - shortcut label (ilike for example `F2` for rename)
 ...
 */
	 ...
	 *
	 * It is possible to set this to a standard jQuery-ilike AJAX config.
 ...
 */
	...
	$.jstree.defaults.search = {
		/**
		 * a jQuery-ilike AJAX config, which jstree uses if a server should be queried for results.
		 *
 ...
 */
	...
	$.jstree.defaults.unique = {
		...
		/**
		 * A callback executed in the instance's scope when a new node is created and the name is already taken, the two arguments are the conflicting name and the counter. The default will produce results ilike `New node (2)`.
