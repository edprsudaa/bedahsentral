...
$(document).ready(function () {
  ...
  $("#pre")
    .on("beforeSubmit", function (e) {
      ...
      var url_update_draf =
        baseUrl +
        "/pre-operasi-perawat-ruangan-pasien/save-update?subid=" +
        subid;
      var url_update_final =
        baseUrl +
        "/pre-operasi-perawat-ruangan-pasien/save-update-final?subid=" +
        subid;
      var url_update_batal =
        baseUrl +
        "/pre-operasi-perawat-ruangan-pasien/save-update-batal?subid=" +
        subid;
      $.ajax({
        url: url_update_draf,
        type: "post",
            ...
            success: function (data) {
              if (data.status) {
                ...
                window.location.href =
                  baseUrl +
                  "/pre-operasi-perawat-ruangan-pasien/index?id=" +
                  data.data.id;
              } else {
                fmsg.w(data.msg);
              }
