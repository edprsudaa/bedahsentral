...
$model = PreOperasiPerawatRuangan::find()->where(['pop_id' => $pop_id])->andWhere('pop_deleted_at is null')->one();
...
<table style="border: 1px solid; width: 100%;" style="<?= $style ?>">
  ...
  <tr>
    ...
    <td colspan="10">
      <?php
      echo Date("d-m-Y", strtotime($tim->to_tanggal_operasi));
      ?>
    </td>
  </tr>
  <tr>
...
<table border="1" cellspacing="0" width="100%" style="<?= $style ?>">
  ...
  <tr>
    ...
    <td>
      <?= $model->pop_sio_ruangan ?>
    </td>
    <td>
      <?= $model->pop_sio_ruangan_ket ?>
    </td>
  </tr>
  <tr>
    <td>2</td>
    ...
    <td>
      <?= $model->pop_puasa_ruangan ?>
    </td>
    <td>
      <?= $model->pop_puasa_ruangan_ket ?>
    </td>
  </tr>
  <tr>
    <td>3</td>
    ...
    <td>
      <?= $model->pop_protesa_ruangan ?>
    </td>
    <td>
      <?= $model->pop_protesa_ruangan_ket ?>
    </td>
  </tr>
  <tr>
    <td>4</td>
    ...
    <td>
      <?= $model->pop_perhiasan_ruangan ?>
    </td>
    <td>
      <?= $model->pop_perhiasan_ruangan_ket ?>
    </td>
  </tr>
  <tr>
    <td>5</td>
    ...
    <td>
      <?= $model->pop_pdo_ruangan ?>
    </td>
    <td>
      <?= $model->pop_pdo_ruangan_ket ?>
    </td>
  </tr>
  <tr>
    <td>6</td>
    ...
    <td>
      <?= $model->pop_plo_ruangan ?>
    </td>
    <td>
      <?= $model->pop_plo_ruangan_ket ?>
    </td>
  </tr>
  <tr>
    <td>7</td>
    ...
    <td>
      <?= $model->pop_huknah_ruangan ?>
    </td>
    <td>
      <?= $model->pop_huknah_ruangan_ket ?>
    </td>
  </tr>
  <tr>
    <td>8</td>
    ...
    <td>
      <?= $model->pop_fkateter_ruangan ?>
    </td>
    <td>
      <?= $model->pop_fkateter_ruangan_ket ?>
    </td>
  </tr>
  <tr>
    <td>9</td>
    ...
    <td>
      <?= $model->pop_h_lab_ruangan ?>
    </td>
    <td>
      <?= $model->pop_h_lab_ruangan_ket ?>
    </td>
  </tr>
  <tr>
    <td>10</td>
    <td>Rontgen</td> <!-- text -->
    <td>
      <?= $model->pop_rontgen_ruangan ?>
    </td>
    <td>
      <?= $model->pop_rontgen_ruangan_ket ?>
    </td>
  </tr>
  <tr>
    <td>11</td>
    <td>USG</td> <!-- text -->
    <td>
      <?= $model->pop_usg_ruangan ?>
    </td>
    <td>
      <?= $model->pop_usg_ruangan_ket ?>
    </td>
  </tr>
  <tr>
    <td>12</td>
    <td>CT- Scan</td> <!-- text -->
    <td>
      <?= $model->pop_ctscan_ruangan ?>
    </td>
    <td>
      <?= $model->pop_ctscan_ruangan_ket ?>
    </td>
  </tr>
  <tr>
    <td>13</td>
    <td>EKG</td> <!-- text -->
    <td>
      <?= $model->pop_ekg_ruangan ?>
    </td>
    <td>
      <?= $model->pop_ekg_ruangan_ket ?>
    </td>
  </tr>
  <tr>
    <td>14</td>
    <td>ECHO</td> <!-- text -->
    <td>
      <?= $model->pop_echo_ruangan ?>
    </td>
    <td>
      <?= $model->pop_echo_ruangan_ket ?>
    </td>
  </tr>
  <tr>
    <td>15</td>
    ...
    <td>
      <?= $model->pop_persediaan_darah_ruangan ?>
    </td>
    <td>
      <?= $model->pop_persediaan_darah_ruangan_ket ?>
    </td>
  </tr>
  <tr>
    <td>16</td>
    ...
    <td>
      <?= $model->pop_ivline_ruangan ?>
    </td>
    <td>
      <?= $model->pop_ivline_ruangan_ket ?>
    </td>
  </tr>
  <tr>
    <td>17</td>
    ...
    <td>
      <?= $model->pop_alergi_obat_ruangan ?>
    </td>
    <td>
      <?= $model->pop_alergi_obat_ruangan_ket ?>
    </td>
  </tr>
  <tr>
    <td>18</td>
  ...
  <tr>
    ...
    <td>
      <?= $model->pop_tkn_darah_ruangan ?>
    </td>
    <td>
      <?= $model->pop_tkn_darah_ruangan_ket ?>
    </td>
  </tr>
  <tr>
    <td>20</td>
    <td>Nadi</td> <!-- text -->
    <td>
      <?= $model->pop_nadi_ruangan ?>
    </td>
    <td>
      <?= $model->pop_nadi_ruangan_ket ?>
    </td>
  </tr>
  <tr>
    <td>21</td>
    <td>Suhu</td> <!-- text -->
    <td>
      <?= $model->pop_suhu_ruangan ?>
    </td>
    <td>
      <?= $model->pop_suhu_ruangan_ket ?>
    </td>
  </tr>
  <tr>
    <td>22</td>
    ...
    <td>
      <?= $model->pop_pernapasan_ruangan ?>
    </td>
    <td>
      <?= $model->pop_pernapasan_ruangan_ket ?>
    </td>
  </tr>
</table>
<table>
