...
<?= $form->field($model, 'pop_batal_ruangan')->hiddenInput()->label(false); ?>
    ...
    <div class="row icon-sticky">
      <div class="col-lg-12">
        <div class="btn-group-vertical">
          ...
          <?= Html::a('<i class="fas fa-times"></i> Kembali', ['/pre-operasi-perawat-ruangan-pasien/index', 'id' => Yii::$app->request->get('id')], ['class' => 'btn btn-danger']) ?>
        </div>
      </div>
    </div>
  </div>
