...
<div class="row">
  <div class="col-lg-11">
    <?php
    $test = TimOperasi::find()->where(['to_id' => $model->pop_to_id])->all();
    $modelruangan = PreOperasiPerawatRuangan::find()->where(['pop_id' => $model->pop_id])->andWhere('pop_deleted_at is null')->orderBy(['pop_created_at' => SORT_DESC])->one();
    ?>
    ...
    <table border="1" cellspacing="0" width="100%">
      ...
      <tr>
        ...
        <td>
          ...
          echo $form->field($modelruangan, 'pop_sio_ruangan', ['options' => ['class' => 'form-group custom-margin']])->radioList($pop_sio_ruangan, [
      ...
      <tr>
        ...
        <td>
          ...
          echo $form->field($modelruangan, 'pop_puasa_ruangan', ['options' => ['class' => 'form-group custom-margin']])->radioList($pop_puasa_ruangan, [
            'item' => function ($index, $label, $name, $checked, $value) {
              return '<div class="custom-control custom-radio custom-control-inline">
              <input id="rd' . $index . '" type="radio" class="custom-control-input" name="' . $name . '" value="' . $value . '" ' . ($checked ? "checked" : "") . ' disabled><label class="custom-control-label" for="rd' . $index . '">' . $label . '</label></div>';
            }
      ...
      <tr>
        ...
        <td>
          ...
          echo $form->field($modelruangan, 'pop_protesa_ruangan', ['options' => ['class' => 'form-group custom-margin']])->radioList($pop_protesa_ruangan, [
            'item' => function ($index, $label, $name, $checked, $value) {
              return '<div class="custom-control custom-radio custom-control-inline">
              <input id="rd' . $index . '" type="radio" class="custom-control-input" name="' . $name . '" value="' . $value . '" ' . ($checked ? "checked" : "") . ' disabled><label class="custom-control-label" for="rd' . $index . '">' . $label . '</label></div>';
            }
      ...
      <tr>
        ...
        <td>
          ...
          echo $form->field($modelruangan, 'pop_perhiasan_ruangan', ['options' => ['class' => 'form-group custom-margin']])->radioList($pop_perhiasan_ruangan, [
            'item' => function ($index, $label, $name, $checked, $value) {
              return '<div class="custom-control custom-radio custom-control-inline">
              <input id="rd' . $index . '" type="radio" class="custom-control-input" name="' . $name . '" value="' . $value . '" ' . ($checked ? "checked" : "") . ' disabled><label class="custom-control-label" for="rd' . $index . '">' . $label . '</label></div>';
            }
      ...
      <tr>
        ...
        <td>
          ...
          echo $form->field($modelruangan, 'pop_pdo_ruangan', ['options' => ['class' => 'form-group custom-margin']])->radioList($pop_pdo_ruangan, [
            'item' => function ($index, $label, $name, $checked, $value) {
              return '<div class="custom-control custom-radio custom-control-inline">
              <input id="rd' . $index . '" type="radio" class="custom-control-input" name="' . $name . '" value="' . $value . '" ' . ($checked ? "checked" : "") . ' disabled><label class="custom-control-label" for="rd' . $index . '">' . $label . '</label></div>';
            }
      ...
      <tr>
        ...
        <td>
          ...
          echo $form->field($modelruangan, 'pop_plo_ruangan', ['options' => ['class' => 'form-group custom-margin']])->radioList($pop_plo_ruangan, [
            'item' => function ($index, $label, $name, $checked, $value) {
              return '<div class="custom-control custom-radio custom-control-inline">
              <input id="rd' . $index . '" type="radio" class="custom-control-input" name="' . $name . '" value="' . $value . '" ' . ($checked ? "checked" : "") . ' disabled><label class="custom-control-label" for="rd' . $index . '">' . $label . '</label></div>';
            }
      ...
      <tr>
        ...
        <td>
          ...
          echo $form->field($modelruangan, 'pop_huknah_ruangan', ['options' => ['class' => 'form-group custom-margin']])->radioList($pop_huknah_ruangan, [
            'item' => function ($index, $label, $name, $checked, $value) {
              return '<div class="custom-control custom-radio custom-control-inline">
              <input id="rd' . $index . '" type="radio" class="custom-control-input" name="' . $name . '" value="' . $value . '" ' . ($checked ? "checked" : "") . ' disabled><label class="custom-control-label" for="rd' . $index . '">' . $label . '</label></div>';
            }
      ...
      <tr>
        ...
        <td>
          ...
          echo $form->field($modelruangan, 'pop_fkateter_ruangan', ['options' => ['class' => 'form-group custom-margin']])->radioList($pop_fkateter_ruangan, [
            'item' => function ($index, $label, $name, $checked, $value) {
              return '<div class="custom-control custom-radio custom-control-inline">
              <input id="rd' . $index . '" type="radio" class="custom-control-input" name="' . $name . '" value="' . $value . '" ' . ($checked ? "checked" : "") . ' disabled><label class="custom-control-label" for="rd' . $index . '">' . $label . '</label></div>';
            }
      ...
      <tr>
        ...
        <td>
          ...
          echo $form->field($modelruangan, 'pop_h_lab_ruangan', ['options' => ['class' => 'form-group custom-margin']])->radioList($pop_h_lab_ruangan, [
            'item' => function ($index, $label, $name, $checked, $value) {
              return '<div class="custom-control custom-radio custom-control-inline">
              <input id="rd' . $index . '" type="radio" class="custom-control-input" name="' . $name . '" value="' . $value . '" ' . ($checked ? "checked" : "") . ' disabled><label class="custom-control-label" for="rd' . $index . '">' . $label . '</label></div>';
            }
      ...
      <tr>
        ...
        <td>
          ...
          echo $form->field($modelruangan, 'pop_rontgen_ruangan', ['options' => ['class' => 'form-group custom-margin']])->radioList($pop_rontgen_ruangan, [
            'item' => function ($index, $label, $name, $checked, $value) {
              return '<div class="custom-control custom-radio custom-control-inline">
              <input id="rd' . $index . '" type="radio" class="custom-control-input" name="' . $name . '" value="' . $value . '" ' . ($checked ? "checked" : "") . ' disabled><label class="custom-control-label" for="rd' . $index . '">' . $label . '</label></div>';
            }
      ...
      <tr>
        ...
        <td>
          ...
          echo $form->field($modelruangan, 'pop_usg_ruangan', ['options' => ['class' => 'form-group custom-margin']])->radioList($pop_usg_ruangan, [
            'item' => function ($index, $label, $name, $checked, $value) {
              return '<div class="custom-control custom-radio custom-control-inline">
              <input id="rd' . $index . '" type="radio" class="custom-control-input" name="' . $name . '" value="' . $value . '" ' . ($checked ? "checked" : "") . ' disabled><label class="custom-control-label" for="rd' . $index . '">' . $label . '</label></div>';
            }
      ...
      <tr>
        ...
        <td>
          ...
          echo $form->field($modelruangan, 'pop_ctscan_ruangan', ['options' => ['class' => 'form-group custom-margin']])->radioList($pop_ctscan_ruangan, [
            'item' => function ($index, $label, $name, $checked, $value) {
              return '<div class="custom-control custom-radio custom-control-inline">
              <input id="rd' . $index . '" type="radio" class="custom-control-input" name="' . $name . '" value="' . $value . '" ' . ($checked ? "checked" : "") . ' disabled><label class="custom-control-label" for="rd' . $index . '">' . $label . '</label></div>';
            }
      ...
      <tr>
        ...
        <td>
          ...
          echo $form->field($modelruangan, 'pop_ekg_ruangan', ['options' => ['class' => 'form-group custom-margin']])->radioList($pop_ekg_ruangan, [
            'item' => function ($index, $label, $name, $checked, $value) {
              return '<div class="custom-control custom-radio custom-control-inline">
              <input id="rd' . $index . '" type="radio" class="custom-control-input" name="' . $name . '" value="' . $value . '" ' . ($checked ? "checked" : "") . ' disabled><label class="custom-control-label" for="rd' . $index . '">' . $label . '</label></div>';
            }
      ...
      <tr>
        ...
        <td>
          ...
          echo $form->field($modelruangan, 'pop_echo_ruangan', ['options' => ['class' => 'form-group custom-margin']])->radioList($pop_echo_ruangan, [
            'item' => function ($index, $label, $name, $checked, $value) {
              return '<div class="custom-control custom-radio custom-control-inline">
              <input id="rd' . $index . '" type="radio" class="custom-control-input" name="' . $name . '" value="' . $value . '" ' . ($checked ? "checked" : "") . ' disabled><label class="custom-control-label" for="rd' . $index . '">' . $label . '</label></div>';
            }
      ...
      <tr>
        ...
        <td>
          ...
          echo $form->field($modelruangan, 'pop_persediaan_darah_ruangan', ['options' => ['class' => 'form-group custom-margin']])->radioList($pop_persediaan_darah_ruangan, [
            'item' => function ($index, $label, $name, $checked, $value) {
              return '<div class="custom-control custom-radio custom-control-inline">
              <input id="rd' . $index . '" type="radio" class="custom-control-input" name="' . $name . '" value="' . $value . '" ' . ($checked ? "checked" : "") . ' disabled><label class="custom-control-label" for="rd' . $index . '">' . $label . '</label></div>';
            }
      ...
      <tr>
        ...
        <td>
          ...
          echo $form->field($modelruangan, 'pop_ivline_ruangan', ['options' => ['class' => 'form-group custom-margin']])->radioList($pop_ivline_ruangan, [
            'item' => function ($index, $label, $name, $checked, $value) {
              return '<div class="custom-control custom-radio custom-control-inline">
              <input id="rd' . $index . '" type="radio" class="custom-control-input" name="' . $name . '" value="' . $value . '" ' . ($checked ? "checked" : "") . ' disabled><label class="custom-control-label" for="rd' . $index . '">' . $label . '</label></div>';
            }
      ...
      <tr>
        ...
        <td>
          ...
          echo $form->field($modelruangan, 'pop_propilaksis_ruangan', ['options' => ['class' => 'form-group custom-margin']])->radioList($pop_propilaksis_ruangan, [
            'item' => function ($index, $label, $name, $checked, $value) {
              return '<div class="custom-control custom-radio custom-control-inline">
              <input id="rd' . $index . '" type="radio" class="custom-control-input" name="' . $name . '" value="' . $value . '" ' . ($checked ? "checked" : "") . ' disabled><label class="custom-control-label" for="rd' . $index . '">' . $label . '</label></div>';
            }
      ...
      <tr>
        ...
        <td>
          ...
          echo $form->field($modelruangan, 'pop_alergi_obat_ruangan', ['options' => ['class' => 'form-group custom-margin']])->radioList($pop_alergi_obat_ruangan, [
            'item' => function ($index, $label, $name, $checked, $value) {
      ...
      <tr>
        ...
        <td>Tekanan Darah</td>
        <td>
          <?= $form->field($modelruangan, 'pop_tkn_darah_ruangan', ['options' => ['class' => 'form-group custom-margin']])->textInput(['class' => 'form-control form-control-sm', 'placeholder' => '......./.....mmHg', 'type' => 'text', 'disabled' => true])->label(false); ?>
        </td>
        <td>
      ...
      <tr>
        ...
        <td>Nadi</td>
        <td>
          <?= $form->field($modelruangan, 'pop_nadi_ruangan', ['options' => ['class' => 'form-group custom-margin']])->textInput(['class' => 'form-control form-control-sm', 'placeholder' => '.........x/mnt', 'type' => 'text', 'disabled' => true])->label(false); ?>
        </td>
        <td>
      ...
      <tr>
        ...
        <td>Suhu</td>
        <td>
          <?= $form->field($modelruangan, 'pop_suhu_ruangan', ['options' => ['class' => 'form-group custom-margin']])->textInput(['class' => 'form-control form-control-sm', 'placeholder' => '...°C', 'type' => 'text', 'disabled' => true])->label(false); ?>
        </td>
        <td>
      ...
      <tr>
        ...
        <td>Pernafasan</td>
        <td>
          <?= $form->field($modelruangan, 'pop_pernapasan_ruangan', ['options' => ['class' => 'form-group custom-margin']])->textInput(['class' => 'form-control form-control-sm', 'placeholder' => '.........x/mnt', 'type' => 'text', 'disabled' => true])->label(false); ?>
        </td>
        <td>
    ...
    <div class="row icon-sticky">
      <div class="col-lg-12">
        <div class="btn-group-vertical">
          <?php
          if (!$model->pop_batal_ok) {
            if (!$model->pop_final_ok) {
              ...
              echo $form->field($model, 'pop_batal_ok')->widget(SwitchInput::classname(), [
                'pluginOptions' => [
                  'size' => 'mini',
                  'onText' => 'Batal',
                  'offText' => 'Non-batal',
            ...
            <button type="submit" class="btn btn-success btn-submit" data-subid="<?= $model->pop_id ?>">
