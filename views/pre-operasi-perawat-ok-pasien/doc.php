...
$model = PreOperasiPerawatOk::find()->where(['pop_id' => $pop_id])->andWhere('pop_deleted_at is null')->one();
...
<table border="1" cellspacing="0" width="100%" style="<?= $style ?>">
  ...
  <tr>
    ...
    <td>
      <?= $model->pop_protesa_ok ?>
    </td>
    <td>
      <?= $model->pop_protesa_ok_ket ?>
    </td>
  </tr>
  <tr>
    <td>4</td>
    ...
    <td>
      <?= $model->pop_perhiasan_ok ?>
    </td>
    <td>
      <?= $model->pop_perhiasan_ok_ket ?>
    </td>
  </tr>
  <tr>
    <td>5</td>
  ...
  <tr>
    ...
    <td>
      <?= $model->pop_fkateter_ok ?>
    </td>
    <td>
      <?= $model->pop_fkateter_ok_ket ?>
    </td>
  </tr>
  <tr>
    <td>9</td>
  ...
  <tr>
    ...
    <td>Rontgen</td> <!-- text -->
    <td>
      <?= $model->pop_rontgen_ok ?>
    </td>
    <td>
      <?= $model->pop_rontgen_ok_ket ?>
    </td>
  </tr>
  <tr>
    <td>11</td>
  ...
  <tr>
    ...
    <td>
      <?= $model->pop_persediaan_darah_ok ?>
    </td>
    <td>
      <?= $model->pop_persediaan_darah_ok_ket ?>
    </td>
  </tr>
  <tr>
    <td>16</td>
  ...
  <tr>
    ...
    <td>
      <?= $model->pop_alergi_obat_ok ?>
    </td>
    <td>
      <?= $model->pop_alergi_obat_ok_ket ?>
    </td>
  </tr>
  <tr>
    <td>18</td>
  ...
  <tr>
    ...
    <td>
      <?= $model->pop_tkn_darah_ok ?>
    </td>
    <td>
      <?= $model->pop_tkn_darah_ok_ket ?>
    </td>
  </tr>
  <tr>
    <td>20</td>
  ...
  <tr>
    ...
    <td>
      <?= $model->pop_pernapasan_ok ?>
    </td>
    <td>
      <?= $model->pop_pernapasan_ok_ket ?>
    </td>
  </tr>
</table>
<table>
