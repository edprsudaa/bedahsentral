$(document).ready(function () {
  $("#mstr")
    .on("beforeSubmit", function (e) {
      ...
      var url_update_draf =
        baseUrl +
        "/serah-terima-ruangan-pasien-medis/save-update?subid=" +
        subid;
      var url_update_final =
        baseUrl +
        "/serah-terima-ruangan-pasien-medis/save-update-final?subid=" +
        subid;
      var url_update_batal =
        baseUrl +
        "/serah-terima-ruangan-pasien-medis/save-update-batal?subid=" +
        subid;
      $.ajax({
        url: url_update_draf,
        type: "post",
            ...
            success: function (data) {
              if (data.status) {
                ...
                window.location.href =
                  baseUrl +
                  "/serah-terima-ruangan-pasien-medis/index?id=" +
                  data.data.id;
              } else {
                fmsg.w(data.msg);
              }
