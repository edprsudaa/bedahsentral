$(document).ready(function () {
  $("#pla")
    .on("beforeSubmit", function (e) {
      ...
      var url_update_draf =
        baseUrl + "/pasca-lokal-anestesi/save-update?subid=" + subid;
      var url_update_final =
        baseUrl + "/pasca-lokal-anestesi/save-update-final?subid=" + subid;
      var url_update_batal =
        baseUrl + "/pasca-lokal-anestesi/save-update-batal?subid=" + subid;
      $.ajax({
        url: url_update_draf,
        type: "post",
        dataType: "json",
            ...
            success: function (data) {
              if (data.status) {
                ...
                window.location.href =
                  baseUrl + "/pasca-lokal-anestesi/index?id=" + data.data.id;
              } else {
                fmsg.w(data.msg);
              }
            },
