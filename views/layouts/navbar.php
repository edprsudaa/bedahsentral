...
<nav class="<?= Yii::$app->params['setting']['adminlte']['navbar_class'] ?>">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item  mt-1">
      <span class="text-lg text-success"><i class="fa fa-plus-square" aria-hidden="true"></i> EMR <b>BEDAH SENTRAL</b><b></b></span>
    </li>
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown user-menu">
      <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
        <img src="<?= \yii\helpers\Url::base() . "/icon/favicon.ico" ?>" class="user-image img-circle elevation-2" alt="User Image">
