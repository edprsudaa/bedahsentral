      ...
      <div class="card-body" style="min-height:180px !important;padding:0.5rem !important;margin-bottom: -24px;">
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="row">
              ...
              <div class="col-lg-4">
                ...
                <h6 class="text-sm text-white"><?php $umur = HelperGeneral::getUmur($layanan['registrasi']['pasien']['tgl_lahir'], $layanan['tgl_masuk']);
                                                echo $umur['th'] . ' TH ' . $umur['bl'] . ' BL ' . $umur['hr'] . ' HR'; ?></h6>
              </div>
              <div class="col-lg-4">
          ...
          <div class="col-lg-4">
            ...
            <div class="row">
              <div class="col-lg-12">
                <a href="#" class="btn btn-warning btn-sm col-lg-12" data-id="0" id="kembali">
