  ...
  <div class="col-lg-11">
    ...
    <div class='row'>
      ...
      <div class="col-lg-6" style="font-size: 12pt;">
        ...
        //     'placeholder' => 'Klik disini, Cari Nama Pasien / NO.RM Pasien / NO.REG Pasien...',
        //   ],
        //   'theme' => Select2::THEME_KRAJEE,
        //   'initValueText' =>
        //   '<b>No.RM</b> : ' . $chk_pasien['registrasi']['pasien_kode']
        //     . ' <b>Nama</b> : ' . $chk_pasien['registrasi']['pasien']['nama']
        //     . ' <b>Ruangan</b> : ' . ($chk_pasien['unit'] ? $chk_pasien['unit']['nama'] : "kosong")
        //     . ' <b>Tgl.Masuk</b> : ' . date('d-m-Y H:i', strtotime($chk_pasien['tgl_masuk'])),
        //   'pluginOptions' => [
        //     'allowClear' => true,
