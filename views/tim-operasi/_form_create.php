...
<div class="row">
  <div class="col-lg-11">
    <div class="row">
              ...
              <div class="col-lg-12">
                ...
                echo $form->field($model, "to_ruang_asal_pl_id")->widget(Select2::classname(), [
                  'options' => [
                    ...
                    'placeholder' => 'Klik disini, Ketik No. Registrasi ...',
                  ],
                ...
                ])->label('Pasien : <b><span style="font-size: 13px;color: red;important;"><u><i>(Ketik No. Registrasi)</i></u></span></b>');
                ?>
              </div>

              <div class="col-lg-6">
                <?php echo $form->field($model, 'to_diagnosa_medis_pra_bedah')->textarea(['rows' => 2, 'style' => 'max-height:60px;min-height:60px'])->label('Diagnosa : <b><span style="font-size: 13px;color: red;important;"><u><i>(Ketik Tanda "<span style="color:#000;important;">@</span>" Untuk Bantuan)</i></u></span></b>'); ?>
              </div>

              <!-- <div class="col-lg-4">
                <?php //echo $form->field($model, 'to_diagnosa_medis_pasca_bedah')->textarea(['rows' => 2, 'disabled' => 'disabled'])->label('Diagnosis Pasca Bedah: <b><span style="font-size: 10px;color: #000000;important;"><u><i>(Ketik Tanda "@" Bantuan Pengetikan Diagnosis)</i></u></span></b>'); 
                ?>
              </div> -->

              <div class="col-lg-6">
                <?php echo $form->field($model, 'to_tindakan_operasi')->textarea(['rows' => 2, 'style' => 'max-height:60px;min-height:60px'])->label('Tindakan : <b><span style="font-size: 13px;color: red;important;"><u><i>(Ketik Tanda "<span style="color:#000;important;">@</span>" Untuk Bantuan)</i></u></span></b>'); ?>
              </div>
      ...
      <div class="col-lg-5">
        <div class="card card-outline card-info" style="height: 310px">
          <div class="card-header">
            <h3 class="card-title">Riwayat Pendaftaran Pasien</h3>
          </div>
          <div class="card-body" style="overflow-x: auto;">
            <table class="table table-sm" id="datatabel">
              <tr>
