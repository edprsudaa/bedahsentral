$(document).ready(function () {
  $("#pas")
    .on("beforeSubmit", function (e) {
      ...
      var url_update_draf =
        baseUrl + "/askan-pasca-anestesi/save-update?subid=" + subid;
      var url_update_final =
        baseUrl + "/askan-pasca-anestesi/save-update-final?subid=" + subid;
      var url_update_batal =
        baseUrl + "/askan-pasca-anestesi/save-update-batal?subid=" + subid;
      $.ajax({
        url: url_update_draf,
        type: "post",
        dataType: "json",
            ...
            success: function (data) {
              if (data.status) {
                ...
                window.location.href =
                  baseUrl + "/askan-pasca-anestesi/index?id=" + data.data.id;
              } else {
                fmsg.w(data.msg);
              }
            },
  ...
  $("#pas_obat_inhalasi_it").on("input change focus paste", function (e) {
    $("#pas_obat_inhalasi").val($(this).val());
    $("#pas_obat_inhalasi").prop("checked", true);
  });
  $("#pas_posisi_operasi_it").on("input change focus paste", function (e) {
    $("#pas_posisi_operasi").val($(this).val());
    $("#pas_posisi_operasi").prop("checked", true);
  });
});
