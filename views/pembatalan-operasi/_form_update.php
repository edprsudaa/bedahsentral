    ...
    <div class="row icon-sticky">
      <div class="col-lg-12">
        <div class="btn-group-vertical">
          ...
          // ])->label(false);
          ?>
          <button data-url="<?= Url::to(['/pembatalan-operasi/simpan', 'id' => $model->bat_id]); ?>" type="submit" class="btn btn-success btn-simpan">
          ...
          <button type="button" data-url="<?= Url::to(['/pembatalan-operasi/hapus', 'id' => $model->bat_id]); ?>" class="btn btn-dark btn-hapus">
            <i class="fas fa-trash-alt"></i> Hapus
          </button>

          <button type="button" data-url="<?= Url::to(['/cetak/cetak-pembatalan-operasi', 'id' => $model->bat_id]); ?>" class="btn btn-danger btn-cetak">
