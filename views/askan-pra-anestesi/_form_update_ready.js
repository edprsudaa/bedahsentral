$(document).ready(function () {
  $("#apa")
    .on("beforeSubmit", function (e) {
      ...
      var url_update_draf =
        baseUrl + "/askan-pra-anestesi/save-update?subid=" + subid;
      var url_update_final =
        baseUrl + "/askan-pra-anestesi/save-update-final?subid=" + subid;
      var url_update_batal =
        baseUrl + "/askan-pra-anestesi/save-update-batal?subid=" + subid;
      $.ajax({
        url: url_update_draf,
        type: "post",
        dataType: "json",
