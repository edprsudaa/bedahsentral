...
<?= $form->field($model, 'apa_batal')->hiddenInput()->label(false); ?>
<div class="row">
  <div class="col-lg-11">
    ...
    <div class="row icon-sticky">
      <div class="col-lg-12">
        <div class="btn-group-vertical">
          ...
          <?= Html::a(Yii::t('app', '{title}', ['title' => '<i class="fas fa-times"></i> Kembali']), ['/askan-pra-anestesi/index', 'id' => Yii::$app->request->get('id')], ['class' => 'btn btn-danger']) ?>
        </div>
      </div>
    </div>
  </div>
