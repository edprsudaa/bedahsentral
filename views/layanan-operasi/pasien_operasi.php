            ...
            'buttons' => [
              'delete' => function ($url, $model) {
                ...
                if (($to_created == Akun::user()->id) || (Akun::user()->username == Yii::$app->params['other']['username_root_bedah_sentral'])) {
                  ...
                  return '<a href="#" class="btn btn-danger btn-xs btn-delete m-1" data-url="' . $url . '" data-key="tes" data-layanan="pasien_operasi" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Hapus">
