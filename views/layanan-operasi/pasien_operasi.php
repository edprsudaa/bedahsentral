...
<div class="row">
  <div class="col-lg-12">
    <?php
    if (Yii::$app->request->get('kamar') == LayananOperasiSearch::KAMAR_OK_GROUND) { ?>
      <div class="alert alert-warning alert-dismissible">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
        <h5 style="margin-bottom: 0;"><i class="icon fas fa-syringe"></i> Kamar Operasi <b>OK Ground (Lt. 1)</b></h5>
      </div>
    <?php } elseif (Yii::$app->request->get('kamar') == LayananOperasiSearch::KAMAR_OK_IRD) { ?>
      <div class="alert alert-warning alert-dismissible">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
        <h5 style="margin-bottom: 0;"><i class="icon fas fa-syringe"></i> Kamar Operasi <b>OK IRD (Lt. 2)</b></h5>
      </div>
    <?php } elseif (Yii::$app->request->get('kamar') == LayananOperasiSearch::KAMAR_OK_IBS) { ?>
      <div class="alert alert-warning alert-dismissible">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
        <h5 style="margin-bottom: 0;"><i class="icon fas fa-syringe"></i> Kamar Operasi <b>OK IBS (Lt. 3)</b></h5>
      </div>
    <?php } ?>
            ...
            'buttons' => [
              'delete' => function ($url, $model) {
                foreach ($model->timOperasi as $key => $value) {
                  if (($value->to_created_by == Akun::user()->id) || (Akun::user()->username == Yii::$app->params['other']['username_root_bedah_sentral'])) {
                    ...
                    return '<a href="#" class="btn btn-danger btn-xs btn-delete m-1" data-url="' . $url . '" data-key="tes" data-layanan="pasien_operasi" data-id="' . $value->to_ok_unt_id . '" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Hapus">
              ...
              'pilih' => function ($url, $model) {
                foreach ($model->timOperasi as $key => $value) {
                  ...
                  return '<a href="#" id="pilih" data-url="' . $url . '" class="btn btn-primary btn-xs m-1" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Klik Untuk Pilih Pasien" onclick="localStorage.setItem(\'layanan\', \'pasien_operasi\')">
