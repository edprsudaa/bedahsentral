...
$(document).ready(function () {
  ...
  $("#informconcenttindakandokter-incon_informasi_diagnosis").atwho({
    searchKey: "name",
    at: "@",
    limit: 100,
  ...
  $("#incon")
    .on("beforeSubmit", function (e) {
      ...
      var url_insert_draf =
        baseUrl + "/inform-concent-tindakan-dokter-pasien/save-insert";
      var url_insert_final =
        baseUrl + "/inform-concent-tindakan-dokter-pasien/save-insert-final";
      $.ajax({
        url: url_insert_draf,
        type: "post",
        dataType: "json",
                      ...
                      success: function (data) {
                        if (data.status) {
                          ...
                          window.location.href =
                            baseUrl +
                            "/inform-concent-tindakan-dokter-pasien?id=" +
                            data.data.id +
                            "&subid" +
                            data.data.subid;
                        } else {
