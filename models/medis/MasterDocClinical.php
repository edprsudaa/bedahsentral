 ...
 */
class MasterDocClinical extends \yii\db\ActiveRecord
{
  /**
   * {@inheritdoc}
   */
  ...
  {
    if ($this->isNewRecord) {
      $this->midc_created_by = Akun::user()->id;
      $this->midc_created_at = date('Y-m-d H:i:s');
    } else {
      $this->midc_updated_by = Akun::user()->id;
      $this->midc_updated_at = date('Y-m-d H:i:s');
    }
