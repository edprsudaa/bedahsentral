...
use app\models\medis\AsesmenResikoJatuh;
use app\models\pendaftaran\Layanan;
/**
 * AsesmenResikoJatuhSearch represents the model behind the search form of `app\models\medis\AsesmenResikoJatuh`.
 */
class PasienAsesmenResikoJatuhSearch extends AsesmenResikoJatuh
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['jenis', 'hasil_deskripsi', 'hasil_json', 'langkah_pencegahan_json', 'tanggal_batal', 'created_at', 'updated_at', 'log_data'], 'safe'],
        ];
    }
