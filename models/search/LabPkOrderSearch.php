...
/**
 * LabPkOrderSearch represents the model behind the search form of `app\models\medis\LabPkOrder`.
 */
class LabPkOrderSearch extends LabPkOrder
{
    ...
    public function rules()
    {
        return [
            ...
            [['no_transaksi', 'diagnosa', 'kondisi_sampel', 'catatan', 'created_at', 'updated_at', 'log_data'], 'safe'],
        ];
    }
