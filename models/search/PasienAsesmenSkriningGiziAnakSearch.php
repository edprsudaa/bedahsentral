...
use app\models\medis\AsesmenSkriningGiziAnak;
use app\models\pendaftaran\Layanan;
/**
 * PasienAsesmenSkriningGiziAnakSearch represents the model behind the search form of `app\models\medis\AsesmenSkriningGiziAnak`.
 */
class PasienAsesmenSkriningGiziAnakSearch extends AsesmenSkriningGiziAnak
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['hasil_json', 'tanggal_batal', 'created_at', 'updated_at', 'log_data'], 'safe'],
        ];
    }
    ...
    {
        $query = AsesmenSkriningGiziAnak::find();
