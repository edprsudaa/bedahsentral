...
use app\models\medis\AsesmenNyeri;
use app\models\pendaftaran\Layanan;
/**
 * AsesmenNyeriSearch represents the model behind the search form of `app\models\medis\AsesmenNyeri`.
 */
class PasienAsesmenNyeriSearch extends AsesmenNyeri
{
    /**
     * {@inheritdoc}
     */
