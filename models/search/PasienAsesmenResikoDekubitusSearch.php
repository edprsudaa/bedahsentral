...
use app\models\medis\AsesmenResikoDekubitus;
use app\models\pendaftaran\Layanan;
/**
 * PasienAsesmenResikoDekubitusSearch represents the model behind the search form of `app\models\medis\AsesmenResikoDekubitus`.
 */
class PasienAsesmenResikoDekubitusSearch extends AsesmenResikoDekubitus
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = AsesmenResikoDekubitus::find();
