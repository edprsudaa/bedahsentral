...
use app\models\medis\AsesmenDownScoreIpn;
use app\models\pendaftaran\Layanan;
/**
 * PasienAsesmenDownScoreIpnSearch represents the model behind the search form of `app\models\medis\AsesmenDownScoreIpn`.
 */
class PasienAsesmenDownScoreIpnSearch extends AsesmenDownScoreIpn
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = AsesmenDownScoreIpn::find();
        $query->joinWith([
            'perawat',
            'layanan'=>
